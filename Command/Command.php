...
class Command implements CommandInterface
{
	 ...
	 * @param   Command    $parent  Parent Console.
	 *
	 ...
	 *
	 * @param   Command  $parent  The parent comment.
	 *
	 * @return  Command  Return this object to support chaining.
	 */
	public function setParent(Command $parent)
	{
		$this->parent = $parent;
	...
	public function addArgument($argument, $description = null, $options = array(), \Closure $code = null)
	{
		...
		{
			$argument = new Command($argument, $this->input, $this->output, $this);
		}
