...
/**
 * Tests for the Joomla\Cache\Gaememcached class.
 *
 * @since  1.0
 */
class GaememcachedTest extends \PHPUnit_Framework_TestCase
{
	...
	/**
	 * Tests the Joomla\Cache\Gaememcached::clear method.
	 *
	 * @return  void
	 *
	 * @covers  Joomla\Cache\Gaememcached::clear
	 * @since   1.0
	 */
	...
	/**
	 * Tests the Joomla\Cache\Gaememcached::exists method.
	 *
	 * @return  void
	 *
	 * @covers  Joomla\Cache\Gaememcached::exists
	 * @since   1.0
	 */
	...
	/**
	 * Tests the Joomla\Cache\Gaememcached::get method.
	 *
	 * @return  void
	 *
	 * @covers  Joomla\Cache\Gaememcached::get
	 * @since   1.0
	 */
	...
	/**
	 * Tests the Joomla\Cache\Gaememcached::remove method.
	 *
	 * @return  void
	 *
	 * @covers  Joomla\Cache\Gaememcached::remove
	 * @since   1.0
	 */
	...
	/**
	 * Tests the Joomla\Cache\Gaememcached::set method.
	 *
	 * @return  void
	 *
	 * @covers  Joomla\Cache\Gaememcached::set
	 * @since   1.0
	 */
	...
	protected function setUp()
	{
		...
		try
		{
			$this->instance = new Cache\Gaememcached;
		}
		catch (\Exception $e)
		{
